...
const switch3Instructions = ({navigation}) => {
        ...
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    <Text style={{ color: COLORS.white, ...FONTS.h1 }}>{switchData.switches[2].name}</Text>
                </View>
            </View>
        )
    }
        ...
        return (
            <View>
                <FlatList
                    ...
                    data={switchData.switches[2].instructions}
            ...
            return (
                <View style={{ marginTop: 10 }}>
                    <TouchableOpacity style={styles.button}
                        ...
                        onPress={() => navigation.navigate("Testing Tor2")}> 
...
export default switch3Instructions;