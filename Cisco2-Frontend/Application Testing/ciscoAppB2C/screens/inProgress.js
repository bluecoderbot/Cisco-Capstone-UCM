        ...
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    <Text style={{ color: COLORS.white, ...FONTS.h1 }}>{switchData.switches[0].name}</Text>
                </View>
            </View>
        )
    }
        ...
        return (
            <View>
                <FlatList
                    ...
                    data={switchData.switches[0].instructions}
            ...
            return (
                <View style={{ marginTop: 10 }}>
                    <TouchableOpacity style={styles.button}
                        ...
                        onPress={() => navigation.navigate("Testing Managment")}> 
