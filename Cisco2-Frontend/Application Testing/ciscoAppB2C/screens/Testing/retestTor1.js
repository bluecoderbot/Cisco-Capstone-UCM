            ...
            <View style={{ marginTop: 170, marginHorizontal: 20 }}>
                ...
                <View style={styles.output}>
                    ...
                    <Text style={{ marginLeft: 10, color: COLORS.black, ...FONTS.body3 }}>
                        {switchData.switches[1].name} - {switchData.switches[1].retest}
                    </Text>
                </View>
            </View>
        )
        ...
        return (
            <View>
                <TouchableOpacity style={styles.continueButton}
                    onPress={() => navigation.navigate("switch3Instructions")}>
