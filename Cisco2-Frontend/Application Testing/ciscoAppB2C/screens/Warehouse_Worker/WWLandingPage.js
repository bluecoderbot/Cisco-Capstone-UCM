...
function WWLandingPage({navigation}){
        ...
        return (
            <View style={styles.headerContainer}>
                <View style={styles.header}>
                    <Text style={{ color: COLORS.white, ...FONTS.h1, fontSize: 25 }}>Hello, Warehouse Worker!</Text>
                </View>
            </View>
        )
    }
        ...
        return (
            <View style={{ marginTop: 300 }}>
                <TouchableOpacity style={styles.button}
                    ...
                    onPress={() => navigation.navigate("serialEntries")}> 
